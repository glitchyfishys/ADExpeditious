<script>
import TASAutomatorDocsManPage from "./TASAutomatorDocsManPage";

export default {
  name: "TASAutomatorDocsCommandList",
  components: {
    TASAutomatorDocsManPage
  },
  data() {
    return {
      selectedCommand: -1,
  ...
  computed: {
    categoryNames: () => GameDatabase.reality.TASAutomator.categoryNames,
    commands: () => GameDatabase.reality.TASAutomator.commands,
  },
  methods: {
