<script>
export default {
  name: "TASAutomatorDocsIntroPage",
};
</script>

<template>
  <div>
    Welcome to the Expeditious TAS Automator!
    <br>
    <br>
    This page is an introduction page which gives a very broad overview of everything you can do with the TAS Automator.
    Specific details on various functionality can be found in the How To Play or their respective tabs (when relevant).
    <br>
    <br>
    <b>Scripting Language:</b> The TAS Automator uses a custom scripting language in order to perform certain game actions
    ...
    <br>
    <br>
    <b>Layout:</b> This TAS Automator itself is split up into two halves; the left half contains your script and controls
    for starting, stopping, and repeating its execution, and the right half contains TAS Automator information. Clicking
    <div class="fas fa-expand-arrows-alt c-automator-button-icon" /> in the top-right corner will expand the TAS Automator
    ...
    <div class="fas fa-trash c-automator-button-icon" /> buttons. The TAS Automator will always contain at
    least one script for you to edit; deleting your last one will automatically create a new blank one.
    <br>
    <br>
    <b>Writing Scripts:</b> Scripts in the text editor are made by typing into
    the left half as a text box. You can also use some smaller premade scripts from the
    ...
    <br>
    <br>
    <b>Importing/Exporting:</b> TAS Automator scripts can be exported and imported in text format by using the
    ...
    shown above the TAS automator panels.
    <br>
    <br>
