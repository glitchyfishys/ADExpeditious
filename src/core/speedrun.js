...
export const Speedrun = {
  ...
  get effectiveSpeed() {
    return (this.modifiers.gameSpeed * (player.speedrun.mods.gameSpeedAch ? Achievements.power : 1)) ** (Pelle.isDoomed ? 0.5 : 1);
  },
  defaultModifiers: {
      ADMul: DC.D1,
      ADPow: 1,
  ...
  modifierNames: {
    ADMul: 'AD Multiplier',
    ADPow: 'AD Power',
    GalStrength: "Galaxy Strength",
    TickMul: "Tickspeed Multiplier",
    TickPow: "Tickspeed Power",
    IDMul: 'ID Multiplier',
    IDPow: 'ID Power',
    TDMul: 'TD Multiplier',
    TDPow: 'TD Power',
    ...
    globalGameSpeed: 'Global Game Speed (divide effective game speed for somethings)',
    ...
    galaxyStrength: 'All galaxy strength',
    AMGalaxyStrength: 'Antimatter galaxy strength',
    RepGalaxyStrength: 'Replicanti galaxy strength',
    TacGalaxyStrength: 'Tachyon galaxy strength',

    teresaSacMul: 'Glyph Sacrifice Multiplier',
    ...
    TASCommandsPerTick: "TAS Commands Per Game Tick"
  }
};
