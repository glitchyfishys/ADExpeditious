...
export const pelleRifts = {
  ...
  recursion: {
    ...
    percentage: totalFill => totalFill.plus(1).log10() ** 0.4 / 64000 ** 0.4,
    percentageToFill: percentage => Decimal.pow(10, percentage ** 2.5 * 64000).minus(1),
    effect: totalFill => new Decimal(58 * totalFill.plus(1).log10() ** 0.2 / 64000 ** 0.2),
