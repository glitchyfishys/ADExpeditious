...
export const TASAutomator = {
  ...
  commands: [
          ...
          items: [
            {
              header: "<i>Inline comments</i>",
              description: `
                The TAS Automator unlike the Normal Automator does support comments which are placed after an already functional
                line of code, on the same line. As an example, the single line "studies load name TDI // Load push"
                will still be a valid command. In this case, you want a comment on the same line as a command.
                The TAS Automator allows anything after a valid command because im too lazy to fix it right now.
              `
            },
            {
              header: "<i>Execution speed</i>",
              description: `
                Having comments will not slow down your script, as they are completely skipped during
                compiling and do not count as a command for the purposes of running. For example, even if you have
                a really long explanation in the form of comments on lines 20-40, the Automator will still
                <i>immediately</i> skip from line 19 to 41 during execution.
              `
            },
    ...
    },
    {
      ...
      category: 5,
      syntax: `
        <b>infinityUpgrade</b> [nowait] IDNumber [ping] <br>`,
      description: `Buy Infinity Upgrades.`,
      sections: [
        {
          name: "MODIFIERS",
          items: [
      ...
      examples: [
        "infinityUpgrade 15",
        "infinityUpgrade nowait 6",
        "infinityUpgrade 1 ping",
      ]
    },
    {
      id: 21,
      ...
      category: 5,
      syntax: `
        <b>BreakInfinityUpgrade</b> [nowait] IDNumber [ping] <br>`,
      description: `Buy Break Infinity upgrades.`,
      sections: [
        {
          name: "MODIFIERS",
          items: [
            ...
            },
            {
              header: "<i>IDNumber</i>",
              description: `
                Upgrades are ordered top left to bottom right. I think?
              `
            },
          ]
        }
      ...
      examples: [
        "breakInfinityUpgrade 1 ping",
        "breakInfinityUpgrade nowait 12",
        "breakInfinityUpgrade nowait 3 ping",
      ]
    },
    {
      id: 22,
      ...
      category: 5,
      syntax: `
        <b>upgradeAutobuyer</b> [nowait] IDNumber [ping] <br>`,
      description: `Unlock and Upgrade Autobuyers.`,
      sections: [
        {
          name: "MODIFIERS",
          items: [
            ...
            {
              header: "<i>IDNumber (autobuyer)</i>",
              description: `
                1~8 are Antimatter Dimensions.
                9 is Tickspeed.
                10 is Dimension Boost.
                11 is Galaxy.
                12 is Big Crunch.
              `
            },
      ...
      examples: [
        "upgradeAutobuyer 3",
        "upgradeAutobuyer nowait 12 ping",
        "upgradeAutobuyer 11 ping",
      ]
    },
    {
      id: 23,
      ...
      category: 5,
      syntax: `
        <b>replicantiUpgrade</b> [nowait] IDNumber [ping] <br>`,
      description: `Buy Replicanti Upgrades.`,
      sections: [
        {
          name: "MODIFIERS",
          items: [
            ...
            },
            {
              header: "<i>IDNumber</i>",
              description: `
                Upgrades are ordered left to right.
              `
            },
          ]
        }
      ...
      examples: [
        "replicantiUpgrade nowait 2 ping",
        "replicantiUpgrade 1",
        "replicantiUpgrade 3 ping",
      ]
    },
    {
      id: 24,
      ...
      category: 5,
      syntax: `
        <b>antimatterDimensions</b> [nowait] IDNumber Amount [ping] <br>`,
      description: `Buy Antimatter Dimensions.`,
      sections: [
        {
          name: "MODIFIERS",
          items: [
            {
              ...
              description: `
                If present, the TAS Automator will move on to the next command instead of repeatedly trying on this
                command in situations where the Dimension is not purchasable or already purchased.
              `
            },
            {
              header: "<i>ping</i>",
              description: `
                Adding "ping" will noitfy you when the command has bought a Dimension is brought.
              `
            },
            {
              header: "<i>IDNumber</i>",
              description: `
                Dimensions are ordered 1st to 8th.
              `
            },
            {
              header: "<i>Amount</i>",
              description: `
                1-10 will buy single dimensions.
                11-1000 will buy 10 (x/ 10) dimensions.
                1001+ will buy unlimited dimensions.
              `
            },
          ]
        }
      ...
      examples: [
        "antimatterDimensions nowait 9001 ping",
        "antimatterDimensions 1 5",
        "antimatterDimensions 3 100 ping",
      ]
    },
    {
      id: 25,
      ...
      category: 5,
      syntax: `
        <b>infinityDimensions</b> [nowait] IDNumber {Amount, Unlock} [ping] <br>`,
      description: `Buy Infinity Dimensions.`,
      sections: [
        {
          name: "MODIFIERS",
          items: [
            ...
            },
            {
              header: "<i>Unlock</i>",
              description: `
                Unlocks the dimension without buying it.
              `
            },
            {
              header: "<i>Amount</i>",
              description: `
                1-10 will buy single dimensions.
                11+ will buy unlimited dimensions.
                Also unlocks the dimension.
              `
            },
          ]
        }
      ...
      examples: [
        "infinityDimensions nowait 1 999 ping",
        "infinityDimensions 1 unlock",
        "infinityDimensions 3 999 ping",
      ]
    },
    {
      id: 26,
      ...
      category: 5,
      syntax: `
        <b>timeDimensions</b> [nowait] IDNumber {Amount, Unlock} [ping] <br>`,
      description: `Buy Time Dimensions.`,
      sections: [
        {
          name: "MODIFIERS",
          items: [
      ...
      examples: [
        "timeDimensions nowait 1 999 ping",
        "timeDimensions 1 999",
        "timeDimensions 3 999 ping",
      ]
    },
    {
      id: 27,
      ...
      category: 5,
      syntax: `
        <b>tickspeed</b> [nowait] Amount [ping] <br>`,
      description: `Buy Tickspeed.`,
      sections: [
        {
          name: "MODIFIERS",
          items: [
            {
              ...
              description: `
                If present, the TAS Automator will move on to the next command instead of repeatedly trying on this
                command in situations where the Tickspeed is not purchasable or already purchased.
              `
            },
            {
              header: "<i>ping</i>",
              description: `
                Adding "ping" will noitfy you when the command has bought Tickspeed is brought.
            ...
            },
            {
              header: "<i>Amount</i>",
              description: `
                1-25 will buy single tickspeed.
                26+ will buy unlimited tickspeed.
              `
            },
          ]
        }
    ...
    },
    {
      ...
      category: 5,
      syntax: `
        <b>timeout</b> time (in milliseconds) <br>`,
      description: `Pauses the TAS automator for a time.`,
      examples: [
        "timeOut 2000",
        "timeOut 60000",
      ]
